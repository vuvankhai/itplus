            ...
            'htmlOptions' => array(
		            ...
		            'buttons' => array(
	                    'view'=>array(
	                        ...
	                        'url' => '$this->grid->controller->createUrl("subject/ajaxview", array("id"=>$data->primaryKey,"type"=>$data->ID))',
	                        'imageUrl' => false,
	                    ...
	                    'update' => array(
	                        ...
	                        'url' => '$this->grid->controller->createUrl("subject/ajaxupdate", array("id"=>$data->primaryKey,"type"=>$data->ID))',
	                        'imageUrl' => false,
