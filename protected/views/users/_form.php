...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'Phonenumber', array('class'=>'clearboth text-danger')); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'Email', array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'Email',array('size'=>45,'maxlength'=>45,'class'=>'form-control')); ?>
		<?php echo $form->error($model,'Email', array('class'=>'clearboth text-danger')); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'Address', array('class'=>'control-label')); ?>
		<?php echo $form->textField($model,'Address',array('size'=>50,'maxlength'=>50,'class'=>'form-control')); ?>
		<?php echo $form->error($model,'Address', array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'Avatar', array('class'=>'clearboth text-danger')); ?>
	</div>
