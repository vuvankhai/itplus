...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'ID_Class',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'ID_Room',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'ID_Hour',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'ID_Subject',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'ID_Facuty',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'Date_Exam',array('class'=>'clearboth text-danger')); ?>
	</div>
