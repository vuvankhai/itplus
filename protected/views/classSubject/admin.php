            ...
            'htmlOptions' => array(
		            ...
		            'buttons' => array(
	                    'view'=>array(
	                        ...
	                        'url' => '$this->grid->controller->createUrl("classsubject/view", array("id"=>$data->primaryKey,"type"=>$data->ID))',
	                        'imageUrl' => false,
	                    ...
	                    'update' => array(
	                        ...
	                        'url' => '$this->grid->controller->createUrl("classsubject/update", array("id"=>$data->primaryKey,"type"=>$data->ID))',
	                        'imageUrl' => false,
