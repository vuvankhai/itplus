...
<h1 class="text-success title">Quản lý Nhóm tài khoản</h1>
    ...
    <div class="fright">
        <?php echo CHtml::ajaxLink("Thêm mới", Yii::app()->createUrl('groupaccount/ajaxcreate'), array('update'=>'#dialog-content'), array('class'=>'btn btn-success btn-sm', 'onClick'=>'$("#dialog-content").dialog("option", "title", "Thêm mới").dialog({resizable: false}).dialog("open"); return false;')); ?>
    </div>
    <?php 
