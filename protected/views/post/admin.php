...
<h1 class="text-success title">Quản lý Bài viết</h1>
    ...
    <div class="fright">
        <?php echo CHtml::ajaxLink("Thêm mới", Yii::app()->createUrl('post/ajaxcreate'), array('update'=>'#dialog-content'), array('class'=>'btn btn-success btn-sm', 'onClick'=>'$("#dialog-content").dialog("option", "title", "Thêm mới").dialog({resizable: false}).dialog("open"); return false;')); ?>
    </div>
    <?php 
