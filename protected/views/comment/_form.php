...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'ID_post',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'Date_comment',array('class'=>'clearboth text-danger')); ?>
	</div>
	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'Student',array('class'=>'clearboth text-danger')); ?>
	</div>
