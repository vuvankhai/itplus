...
<div class="head">
<h1 class="text-success title">Quản lý Nhóm quy tắc</h1>


    <div class="fright">
        <?php echo CHtml::ajaxLink("<span class='glyphicon glyphicon-plus'></span>Thêm mới", Yii::app()->createUrl('grouprules/ajaxcreate'), array('update'=>'#dialog-content'), array('class'=>'btn btn-success btn-sm', 'onClick'=>'$("#dialog-content").dialog("option", "title", "Thêm mới").dialog({resizable: false}).dialog("open"); return false;')); ?>
    </div>
    <?php 
		...
		array(
                    ...
                    'htmlOptions' => array(
                                    ...
                                    'view'=>array(
                                        ...
                                        'url' => '$this->grid->controller->createUrl("grouprules/view", array("id"=>$data->primaryKey,"type"=>$data->ID))',
                                        'imageUrl' => false,
                                        'options'=>array('title'=>'Chi tiết'),
                                        'click'=>'function(){
                                                    $.fn.yiiGridView.update("grouprules-grid", {
                                                        type: "GET",
                                                        url: $(this).attr("href"),
		...
		array(
                    ...
                    'htmlOptions' => array(
                                    ...
                                    'update' => array(
                                        ...
                                        'url' => '$this->grid->controller->createUrl("grouprules/update", array("id"=>$data->primaryKey,"type"=>$data->ID))',
                                        'imageUrl' => false,
		...
		array(
                    ...
                    'htmlOptions' => array(
                                    ...
                                    'delete' => array(
                                        ...
                                        'url' => '$this->grid->controller->createUrl("grouprules/delete", array("id"=>$data->primaryKey,"type"=>$data->ID ))',
                                        'imageUrl' => false,
