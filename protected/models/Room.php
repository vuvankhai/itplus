...
class Room extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ID, Name, Desccription', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'classSubjects' => array(self::HAS_MANY, 'ClassSubject', 'ID_Room'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Desccription',$this->Desccription,true);
