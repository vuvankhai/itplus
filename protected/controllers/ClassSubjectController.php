...
class ClassSubjectController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ClassSubject'];
			if($model->save())
	...
	{
		$model=ClassSubject::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ClassSubject $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='class-subject-form')
		{
