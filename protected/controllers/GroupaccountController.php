...
class GroupaccountController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Groupaccount'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Groupaccount');
	 ...
	 * @param Groupaccount $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='groupaccount-form')
		{
